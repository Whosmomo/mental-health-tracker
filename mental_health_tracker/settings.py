...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "pradipta-wachyu-mentalhealthtracker2.pbp.cs.ui.ac.id"]
...
CSRF_TRUSTED_ORIGINS = ["http://localhost","http://127.0.0.1","http://<URL PWS KAMU>", "https://pradipta-wachyu-mentalhealthtracker2.pbp.cs.ui.ac.id"]